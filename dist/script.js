...
const forms = state => {
  ...
  form.forEach(item => {
    item.addEventListener('submit', e => {
      ...
      }).catch(() => statusMessage.textContent = message.falilure).finally(() => {
        clearInputs();
        setTimeout(() => {
...
//             // show modal
//             modal.style.display = "block";
//             // document.body.style.overflow = "hidden"; // scroll without
...
//     bindModal(callEngineerBtn, modalEngineer, modalClose);
// };
